...
- Discovery Loop continues until primary clean round + sub-agent confirmation with zero issues/gaps
...
- Critical Rules: "Discovery is mandatory", "primary clean round + sub-agent confirmation required to exit", "User approves Discovery before features"
...
- S1.P3.2: Discovery Loop (iterative)
  ...
  - Repeat until primary clean round + sub-agent confirmation with zero issues/gaps
...
- Continue loop until primary clean round + sub-agent confirmation with zero issues/gaps (Validation Loop)
...
- Guide Last Read: {YYYY-MM-DD HH:MM}
- Critical Rules: "primary clean round + sub-agent confirmation to exit loop", "Document all findings", "User approves before features"
...
**When:** Discovery Loop exits (primary clean round + sub-agent confirmation with zero issues/gaps), ready for synthesis
